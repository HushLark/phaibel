...
export class WriteFileNodeCode extends AbstractNodeCode {
    ...
    async process(context) {
        ...
        let filePath = this.getRequiredConfigValue('file_path');
        const createDirs = this.getOptionalConfigValue('create_directories', true);
        ...
        filePath = filePath.replace(/\{(\w+)\}/g, (_, key) => {
