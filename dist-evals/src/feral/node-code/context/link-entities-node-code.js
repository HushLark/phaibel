...
export class LinkEntitiesNodeCode extends AbstractNodeCode {
    ...
    async process(context) {
        const sourceType = this.getRequiredConfigValue('source_entity_type');
        const rawSourceTitle = this.getRequiredConfigValue('source_entity_title');
        const targetType = this.getRequiredConfigValue('target_entity_type');
        const rawTargetTitle = this.getRequiredConfigValue('target_entity_title');
        const rawLabel = this.getRequiredConfigValue('label');
        ...
        const existingLinks = Array.isArray(source.meta.links) ? source.meta.links : [];
