...
export class CreateEntityNodeCode extends AbstractNodeCode {
    ...
    async process(context) {
        ...
        if (typeConfig) {
            ...
            for (const field of typeConfig.fields) {
                ...
                if (field.type === 'enum' && field.values?.length && val !== undefined) {
                    if (!field.values.includes(val) && field.default !== undefined) {
                ...
                if (val === undefined && field.required && field.type === 'string') {
                    ...
                    const tagMatch = tags.find(t => t.toLowerCase() !== entityType && t.length > 1);
                    if (tagMatch) {
        ...
        const created = context.get('created_entities') ?? [];
