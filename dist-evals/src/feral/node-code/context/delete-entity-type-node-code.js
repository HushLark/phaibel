...
export class DeleteEntityTypeNodeCode extends AbstractNodeCode {
    ...
    constructor() {
        super('delete_entity_type', 'Delete Entity Type', 'Removes a custom entity type from the registry. Built-in types (task, note) are protected.', NodeCodeCategory.DATA);
    }
