...
export class CxfPushNodeCode extends AbstractNodeCode {
    ...
    async process(context) {
        const consumerId = this.getRequiredConfigValue('consumer_id');
        const urlPath = this.getOptionalConfigValue('export_url_context_path') ?? 'cxf_export_url';
        const portRaw = this.getOptionalConfigValue('port');
