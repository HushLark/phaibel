 ...
 */
export async function getCollectionItem(collectionName, key) {
 ...
 */
export async function countCollectionItems(collectionName) {
    const collection = await loadCollection(collectionName);
    if (!collection)
        return 0;
...
export async function saveCollection(collection) {
    ...
    const meta = { name: collection.name };
 ...
 */
export async function setCollectionItem(collectionName, key, value, description) {
 ...
 */
export async function removeCollectionItem(collectionName, key) {
    const collection = await loadCollection(collectionName);
    if (!collection || !(key in collection.items))
        return false;
 ...
 */
function parseCollectionBody(body) {
    const items = {};
 ...
 */
function formatCollectionBody(items) {
