 ...
 */
export function resetFoundationCache() {
 ...
 */
export function setFoundationRoot(path) {
    cacheRoot(path);
}
 ...
 */
export async function findFoundationRoot() {
 ...
 */
export async function getPersonalityId() {
    try {
        const state = await loadState();
 ...
 */
export async function isInterviewComplete() {
    const state = await loadState();
...
export async function saveProfile(profile) {
    ...
    if (profile.agentName)
        state.agentName = profile.agentName;
