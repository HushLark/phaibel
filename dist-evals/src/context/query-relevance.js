 ...
 */
export function analyzeQueryRelevance(userInput, entityTypes, entityIndex) {
 ...
 */
export function filterCatalogNodes(allNodes, relevantTypes, entityTypes) {
